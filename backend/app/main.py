...
from app.routes import auth, dashboard, chat, analytics, network, reports, fir, emergency
...
app.include_router(emergency.router, prefix=f"{settings.API_V1_STR}/emergency", tags=["Emergency Response"])
